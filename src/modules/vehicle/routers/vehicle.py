...
@router.post("/customer/{customer_id}/vehicle", status_code=201)
...
@router.get("/customer/{customer_id}/vehicle", status_code=200)
...
@router.delete("/customer/{customer_id}/vehicle/{vehicle_id}", status_code=204)
...
@router.get("/customer/{customer_id}/vehicle/{vehicle_id}", status_code=200)
...
@router.get("/customer/{customer_id}/active-vehicles", status_code=200)
